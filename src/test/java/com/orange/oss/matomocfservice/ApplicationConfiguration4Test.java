 ...
 */
@Configuration
public class ApplicationConfiguration4Test extends ApplicationConfiguration {
	private final static Logger LOGGER = LoggerFactory.getLogger(CloudFoundryMgr.class);

	@Bean
	@ConditionalOnMissingBean(CloudFoundryMgr.class)
	public CloudFoundryMgr defaultCloudFoundryMgr() {
		LOGGER.debug("CONFIG - run in test mode");
		return new CloudFoundryMgr4Test();
	}
}
